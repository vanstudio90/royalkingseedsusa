...
export const categoryContent: Record<string, CategoryContent> = {
  'shop-all-cannabis-seeds': {
    ...
    intro: 'Royal King Seeds is your trusted American source for premium cannabis seeds. Browse our complete collection of over 1,600 feminized, autoflowering, indica, sativa, hybrid, and CBD strains with discreet shipping to all 50 states. Every seed order includes our germination guarantee, competitive pricing, and expert growing support for cultivators of all experience levels across the United States.',
    bottomSections: [
      ...
      { title: 'Shipping Cannabis Seeds Across America', content: 'We ship to all 50 states using plain, unmarked packaging for complete discretion. Orders are processed within 1-2 business days and typically arrive within 3-7 business days via USPS or UPS. Free shipping is available on orders over $150 USD. Every package includes tracking information so you can monitor your delivery from our warehouse to your door.' },
    ],
    faqs: [

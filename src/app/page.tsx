...
export const metadata: Metadata = {
  ...
  description: 'Buy cannabis seeds online in the USA from Royal King Seeds. 1,600+ feminized, autoflower, indica, sativa, and high-THC marijuana seeds with discreet shipping to all 50 states. 95% germination rate. Trusted by 200,000+ American growers since 2019.',
      ...
      <section className="hero-gradient text-white -mt-[132px] pt-[132px] lg:-mt-[88px] lg:pt-[88px]">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-12 sm:py-24 text-center">
          ...
          <div className="mt-5 flex flex-wrap gap-x-6 gap-y-1 justify-center text-[11px] text-white/50 uppercase tracking-[1px]">
            <span>200,000+ US growers served</span>
      ...
      <section className="bg-white border-b border-[#275C53]/5">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-12">
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
            {[
              { stat: 'Since 2019', label: 'Serving American growers with tested genetics for 6+ years', mobileOnly: false, icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#275C53" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg> },
              ...
              { stat: '200,000+', label: 'Trusted by over 200,000 growers across the United States since 2019', mobileOnly: false, icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#275C53" strokeWidth="1.5"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg> },
              { stat: '3-5 Days', label: '94% of US orders delivered within 5 business days via USPS/UPS', mobileOnly: false, icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#275C53" strokeWidth="1.5"><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4l3 3v5a2 2 0 01-2 2h-1"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg> },
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-normal text-[#275C53]" style={{ fontFamily: 'var(--font-patua)' }}>
              Best-Selling Cannabis Seeds in America
            </h2>
            <div className="w-12 h-0.5 bg-[#D7B65D] mx-auto mt-4 mb-4" />
            <p className="text-[#192026]/65">Top-rated strains chosen by American growers for quality, yield, and potency</p>
          </div>
          <FeaturedProducts products={featured} />
          <p className="text-center text-sm text-[#192026]/65 mt-8 max-w-2xl mx-auto leading-relaxed">
            Explore our best-selling marijuana seeds online, including high THC strains, beginner-friendly autoflower genetics, high yield cannabis seeds, and top-performing indoor and outdoor varieties trusted by growers across all 50 states.
          </p>
      ...
      <section className="max-w-[1280px] mx-auto px-4 sm:px-6 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-sm max-w-none text-[#192026]/75 prose-headings:text-[#275C53] prose-headings:font-normal prose-a:text-[#275C53] prose-a:no-underline hover:prose-a:text-[#D7B65D] leading-relaxed">
            ...
            <p>
              After six years and 200,000+ orders, we have clear data on which genetics deliver the most consistent results for American growers at every level. Across 10,000+ seeds tested internally, we have seen the highest germination and harvest success rates with these categories:
            </p>
            <ul>
      ...
      <section className="bg-white/50 border-y border-[#275C53]/5">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 py-12">
          ...
          <p className="text-center text-[#192026]/65 text-sm max-w-3xl mx-auto mb-10">
            The &ldquo;best&rdquo; seed depends on your experience, space, climate, and goals. Here is a straightforward breakdown based on what we have learned from supporting 200,000+ American growers.
          </p>
      ...
      <section className="max-w-[1280px] mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            { title: '95% Germination Rate (Industry-Leading)', desc: 'Based on internal batch testing and customer-reported data from 200,000+ orders. Seeds that fail to meet our 90% viability threshold are pulled from inventory. Our germination guarantee replaces seeds at no cost.', link: '/faq' },
      ...
      <section className="max-w-[1280px] mx-auto px-4 sm:px-6 py-12">
        <div className="bg-[#275C53] rounded-3xl p-8 sm:p-14 text-center">
          ...
          <p className="text-white/75 text-sm sm:text-base max-w-2xl mx-auto mb-6 leading-relaxed">
            Browse over 1,600 premium cannabis strains trusted by 200,000+ American growers. Shop <Link href="/product-category/feminized-seeds" className="text-[#D7B65D] hover:underline">feminized</Link>, <Link href="/product-category/autoflowering-seeds" className="text-[#D7B65D] hover:underline">autoflower</Link>, and <Link href="/product-category/high-tch-seeds" className="text-[#D7B65D] hover:underline">high-yield seeds</Link> with fast, discreet US shipping and a 95% germination guarantee backed by real batch-testing data. Orders placed before 2 PM EST ship the same business day.
          </p>
